...
path_labels = '/Volumes/Elements/Nachrichten und Kurse/StocksMinute'
path_data = '/Volumes/Elements/Nachrichten und Kurse/Reuters_US'
...
def join_data(path_labels, path_data):
	labels = transform_data(load_labels(path_labels), 30)['AAPL'].sort_index()
	data = load_sentences(path_data).sort_index()
